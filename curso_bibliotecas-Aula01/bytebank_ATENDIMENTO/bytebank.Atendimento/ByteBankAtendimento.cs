    ...
    internal  class ByteBankAtendimento
    {
        ...
        private void ExportarContas()
        {
            ...
            else
            {
                ...
                try
                {
                    FileStream fs = new FileStream(@"C:\Users\Usuario\Desktop\Curso Back end C#\curso_bibliotecas-Aula01\contas.json", 
                        FileMode.Create);
                    using (StreamWriter streamwriter = new StreamWriter(fs))
                    {
                        streamwriter.WriteLine(json);
                    }
                    Console.WriteLine(@"C:\Users\Usuario\Desktop\Curso Back end C#\curso_bibliotecas-Aula01");
                    Console.ReadKey();
                }
                catch (Exception excecao)
                {
